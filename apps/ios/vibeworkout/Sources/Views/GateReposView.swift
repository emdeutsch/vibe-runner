...
private let logger = Logger(subsystem: "com.vibeworkout.app", category: "GateReposView")
...
struct GateRepoRow: View {
    ...
    var body: some View {
        ...
        .alert("Install GitHub App", isPresented: $showingInstallAlert) {
            ...
            Text("You need to install the vibeworkout GitHub App on this repository to enable HR signal updates.")
        }
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                // GitHub App Section
                Section {
                    Toggle("Install vibeworkout app after creation", isOn: $autoInstallApp)
                } footer: {
                    Text("The vibeworkout GitHub App is required to update HR signals in your repository.")
                }
                    ...
                    Section {
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            if repo.needsAppInstall && repo.installUrl == nil {
                                Text("Install the vibeworkout GitHub App to enable HR gating.")
                                    .font(.caption)
                                    .foregroundStyle(.orange)
                            }
                        }
